...
a = Analysis(['server.py'],
             ...
             hiddenimports=hiddenimports + ['pkg_resources.py2_warn','tensorflow.compiler.tf2tensorrt', 'deeptrack', 'tensorflow', 'tensorflow_core', 'scipy', 'numpy', 'skimage', 'PIL', 'opencv-python', 'zerorpc'],
             hookspath=[],
             runtime_hooks=[],
             excludes=[],
